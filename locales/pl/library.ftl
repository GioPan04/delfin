...
library-collection-refresh-button = Odśwież kolekcję
library-unnamed-collection = Kolekcje bez nazwy
library-status-refresh-button = Odśwież
library-page-collections-title = Kolekcje
