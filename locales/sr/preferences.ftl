...
prefs-vp-interface = Korisnički prikaz
...
prefs-general-language =
    .title = Jezik
    .subtitle = Pomozite sa prevodom na <a href="{ $weblateUrl }">Weblate</a> stranici
    .option-default = Sistem podrazumevano ({ $languageId })
...
prefs-vp-skip-forwards =
    .title = Koliko sekundi premotati unapred
    .subtitle = Koliko sekundi premotati unapred u jednom koraku
...
prefs-vp-skip-backwards =
    .title = Koliko sekundi premotati unazad
    .subtitle = Koliko sekundi premotati unazad u jednom koraku
...
prefs-vp-page = Video plejer
prefs-vp-plugins = Dodaci
prefs-general-theme =
    .title = Tema
    .option-default = Sistemski podrazumevana
    .option-light = Svetla
    .option-dark = Tamna
